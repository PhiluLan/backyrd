...
5. Implementierung von `CorrectionTargetAuthorityPort`, damit das Zielereignis nachweislich demselben User gehört und zeitlich davor liegt;
6. Independence- und repeated-spot Regeln nur für servergelöste Journeys;
7. event-time World-Evidence-Referenzen;
8. Lifecycle-Propagation bei Correction, Retention und Erasure;
9. deterministischer Full- und Incremental-Chain-Rebuild.
