-- Catalog category is a bounded retrieval hint only. Every returned spot is
-- still resolved and verified through the canonical World manifest. Decision
-- eligibility, ranking and presentation never use catalog order or category.
create function public.backyrd_decision_vnext_product_context_v2(
...
begin
  ...
  select count(*),coalesce(jsonb_agg(jsonb_build_object(
    ...
    'resolvedAt',v.world_snapshot->>'resolvedAt','decisionProjection',v.decision_projection
