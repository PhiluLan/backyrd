-- The bounded catalog is retrieval only. Prefer verified World facts before
-- the legacy catalog-category hint so a known coffee venue cannot be dropped
-- by the 48-row cap. The validated World reader still decides eligibility.
