...
do $$ declare a jsonb;b jsonb;begin
 ...
 perform pg_temp.assert((select source_scope->>'researchPolicyVersion'='backyrd-spot-research-policy-v2.6' from public.backyrd_spot_research_jobs_v1 where id=(a->>'jobId')::uuid),'Research policy version missing from durable source scope');
end $$;
