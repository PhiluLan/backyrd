    ...
    try {
      ...
      if (!servicesEnabled) {
        Alert.alert(
          ...
          "Aktiviere die Ortungsdienste in den iOS-Einstellungen und versuche es erneut.",
        );
        return;
      }
      ...
      if (finalPermission.status !== "granted") {
        Alert.alert(
          ...
          "Erlaube Backyrd den Standortzugriff in den iOS-Einstellungen.",
        );
        return;
      }
      ...
      try {
        ...
        console.warn("[map] current position failed", currentError);
      ...
      if (!pos) {
        Alert.alert(
          "Standort noch nicht verfügbar",
          "iOS konnte noch keine Position liefern. Gehe kurz ins Freie oder öffne Apple Karten und versuche es danach erneut.",
        );
        return;
      }
      ...
      console.warn("[map] recenter failed", error);
      Alert.alert(
        "Standort",
        error?.message
          ? `Standort konnte nicht bestimmt werden: ${error.message}`
