...
export default function PrivacyAdminPage() {
  ...
  async function executeDeletion(requestId: string) {
    const preview = deletionPreview[requestId];

    if (!preview) {
      await previewDeletion(requestId);
      window.alert(
    ...
    window.alert("Das Testkonto wurde vollständig gelöscht.");
    setDeletionPreview((current) => {
      const next = { ...current };
                        ...
                        ["scheduled", "processing", "failed"].includes(
                          ...
                          <>
                            ...
                            <button
                              ...
                              onClick={() =>
                                void executeDeletion(request.request_id)
                              }
                            >
                              {deletingRequestId === request.request_id
                                ? "Löscht …"
