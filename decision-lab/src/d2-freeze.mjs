...
const recertificationPath = resolve(repoRoot, "decision-lab/config/decision-v13-production-recertification-v41.json");
const requiredRecertificationInvariants = Object.freeze({
  ...
  eventsV1MigrationStatementContentMatch: "PASS",
  eventsV1ProductionSchemaFingerprintMatch: "PASS",
  eventsV1ProductionAclFingerprintMatch: "PASS",
  eventsV1ExternalSourcesDisabled: "PASS"
});
...
export async function validateEngineRecertification(contractOverride = null) {
  ...
  const reasons = [
    ...(contract.version === "decision-v13-production-recertification-v41" ? [] : ["RECERTIFICATION_VERSION_INVALID"]),
    ...
    ...(contract.authorization?.previousRecertificationVersion === "decision-v13-production-recertification-v40" && contract.authorization?.previousRecertificationHash === "47a75d0545b206bc8199c75a47db51e1ab2eaef5270593deb5f2d6a498a37859" ? [] : ["PREVIOUS_RECERTIFICATION_IDENTITY_MISMATCH"]),
    ...(contract.authorization?.baseCommit === "73f56e0487d1a56085f5396449ef74ff1e19dc96" ? [] : ["AUTHORIZED_BASE_COMMIT_MISMATCH"]),
    ...(contract.authorization?.authorizedSourceCommit === "ada5f00b5f5fdb8efe9fcc00be7626a14907a70a" ? [] : ["AUTHORIZED_SOURCE_COMMIT_MISMATCH"]),
    ...
    ...(contract.authorization?.changeClass === "P0_GOOGLE_SPOT_IMAGE_CANONICAL_AUTH_SESSION" ? [] : ["AUTHORIZED_CHANGE_CLASS_MISMATCH"]),
...
export async function computeD21Identity() {
  ...
  return {
    ...
    supersedes: recertification.valid
      ? { freezeManifestHash: "1460bc97bf89c7e2238cd6ab203ca545a932ad14d688ce9f2923be034c01320e", reason: "FOUNDER_HOME_HEADER_HIERARCHY_POLISH" }
