...
test("freeze identity is deterministic and validator rejects tampering", async () => {
  ...
  assert.equal(recertification.contract.version, "decision-v13-production-recertification-v34");
  assert.equal(recertification.identity.authorizedSourceCommit, "0ac81d0a23fd3cdead1efd9adeadff2fd93f1e26");
