...
test("freeze identity is deterministic and validator rejects tampering", async () => {
  ...
  assert.equal(recertification.contract.version, "decision-v13-production-recertification-v26");
  assert.equal(recertification.identity.authorizedSourceCommit, "95ba3174787a4f40d6d81dcf107a34eab292a383");
