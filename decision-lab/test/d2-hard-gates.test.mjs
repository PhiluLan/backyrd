...
test("freeze identity is deterministic and validator rejects tampering", async () => {
  ...
  assert.equal(recertification.contract.version, "decision-v13-production-recertification-v21");
  assert.equal(recertification.identity.authorizedSourceCommit, "91d453505ed7ede6a8176f70b83594a8aa2f0917");
