...
test("freeze identity is deterministic and validator rejects tampering", async () => {
  ...
  assert.equal(recertification.contract.version, "decision-v13-production-recertification-v16");
  assert.equal(recertification.identity.authorizedSourceCommit, "c6aafcdeb65e9d73d71e8f69e652f0d47b1a20ed");
