...
test("freeze identity is deterministic and validator rejects tampering", async () => {
  ...
  assert.equal(recertification.contract.version, "decision-v13-production-recertification-v27");
  assert.equal(recertification.identity.authorizedSourceCommit, "8bcb691c16d5f15bc6ec9598244c580fd55373dc");
