...
async function cloneWithConsumerUnderTest(prefix) {
  ...
  for (const path of ["decision-lab/src/d2-cli.mjs", "decision-lab/src/d3.1-readiness.mjs", "decision-lab/src/recertification-apply.mjs", "decision-lab/src/recertification-cli.mjs", "decision-lab/src/recertification-consumer.mjs", "decision-lab/src/recertification-verify.mjs"]) await writeFile(join(root, path), await readFile(join(source, path)));
