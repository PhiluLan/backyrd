...
recertification_contract='decision-lab/config/decision-v13-production-recertification-v42.json'
...
if [[ -f "$recertification_contract" ]] \
  ...
  echo "D2 scope guard: complete v42 Engine/Source/Evidence/Freeze/Production re-certification accepted"
fi
