...
recertification_contract='decision-lab/config/decision-v13-production-recertification-v38.json'
...
if [[ -f "$recertification_contract" ]] \
  ...
  echo "D2 scope guard: complete v38 Engine/Source/Evidence/Freeze/Production re-certification accepted"
fi
