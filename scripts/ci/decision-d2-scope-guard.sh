...
recertification_contract='decision-lab/config/decision-v13-production-recertification-v13.json'
...
if [[ -f "$recertification_contract" ]] \
  ...
  echo "D2 scope guard: complete v13 Engine/Source/Evidence/Freeze/Production re-certification accepted"
fi
...
# exemption; current changes require the complete v13 contract above.
