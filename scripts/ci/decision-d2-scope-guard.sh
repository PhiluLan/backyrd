...
recertification_contract='decision-lab/config/decision-v13-production-recertification-v28.json'
...
if [[ -f "$recertification_contract" ]] \
  ...
  echo "D2 scope guard: complete v28 Engine/Source/Evidence/Freeze/Production re-certification accepted"
fi
