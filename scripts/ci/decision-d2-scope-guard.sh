...
recertification_contract='decision-lab/config/decision-v13-production-recertification-v10.json'
...
if [[ -f "$recertification_contract" ]] \
  ...
  echo "D2 scope guard: complete v10 Engine/Source/Evidence/Freeze/Production re-certification accepted"
fi
...
# exemption; current changes require the complete v10 contract above.
