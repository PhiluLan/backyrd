...
recertification_contract='decision-lab/config/decision-v13-production-recertification-v14.json'
...
if [[ -f "$recertification_contract" ]] \
  ...
  echo "D2 scope guard: complete v14 Engine/Source/Evidence/Freeze/Production re-certification accepted"
fi
...
# exemption; current changes require the complete v14 contract above.
