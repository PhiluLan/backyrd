...
const tracks = [
  ...
  { track: "DECISION_SERVER_AUTHORITY", tests: ["packages/decision-vnext-core/test/founder-live-api.test.mjs", "packages/decision-vnext-core/test/founder-live-runtime-bootstrap.test.mjs", "packages/decision-vnext-core/test/founder-live-runtime-capability.test.mjs", "packages/decision-vnext-core/test/isolation.test.mjs", "supabase/functions/decision-founder-live/runtime-bootstrap.test.mjs", "scripts/ci/founder-live-runtime-bootstrap.test.mjs"] },
