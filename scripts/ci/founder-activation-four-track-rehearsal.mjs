...
const tracks = [
  ...
  { track: "USER_UUID_AUTHORITY", tests: ["packages/user-intelligence-vnext-core/test/founder-live-projection.test.mjs", "packages/user-intelligence-vnext-core/test/founder-live-uuid-authority.test.mjs", "packages/user-intelligence-vnext-core/test/production-relevant-user-projection.test.mjs"] },
  { track: "DECISION_SERVER_AUTHORITY", tests: ["packages/decision-vnext-core/test/founder-live-api.test.mjs", "packages/decision-vnext-core/test/founder-live-runtime-bootstrap.test.mjs", "packages/decision-vnext-core/test/founder-live-runtime-capability.test.mjs", "packages/decision-vnext-core/test/isolation.test.mjs", "supabase/functions/decision-founder-live/runtime-bootstrap.test.mjs", "supabase/functions/decision-founder-live/runtime-production.test.mjs", "scripts/ci/founder-live-runtime-bootstrap.test.mjs"] },
