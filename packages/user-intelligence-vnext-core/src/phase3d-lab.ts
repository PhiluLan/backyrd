...
export const PHASE3D_SCENARIO_IDS = Object.freeze([
  ...
  "ui-search-pattern", "ui-familiarity", "ui-satisfaction", "ui-negative-situation", "ui-conflict", "ui-dwell", "ui-correction-retry", "ui-lifecycle", "ui-reload", "ui-narrow-viewport",
] as const);
export const PHASE3D_SCENARIO_SET_VERSION = "backyrd.user-intelligence.founder-lab-scenarios@3d-2";
