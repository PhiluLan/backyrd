...
export const PHASE3B_CALIBRATION_SCENARIOS: readonly CalibrationScenario[] = Object.freeze([
  ...
  scenario("10-positive-and-negative-parallel", [
    positive("mixed-positive", "journey-mixed-positive", "spot-mixed-positive", { concepts: [{ registryVersion: PHASE3B_SYNTHETIC_REGISTRY, conceptId: "vibe.synthetic-cozy", certainty: "SUPPORTED" }], context: context("friends") }),
    negative("mixed-negative", "journey-mixed-negative", "spot-mixed-negative", { concepts: [{ registryVersion: PHASE3B_SYNTHETIC_REGISTRY, conceptId: "environment.synthetic-outdoor", certainty: "SUPPORTED" }], context: context("friends") }),
  ]),
  ...
  scenario("22-conflicting-evidence", [positive("conflict-positive", "journey-conflict-positive", "spot-conflict", { context: context("friends") }), negative("conflict-negative", "journey-conflict-negative", "spot-conflict", { context: context("friends") })]),
