...
export const CONTRACT_VERSIONS = Object.freeze({
  ...
  signalSemanticsRegistry: "backyrd.user-intelligence.signal-semantics-registry@3b.1",
  calibrationPolicy: "backyrd.user-intelligence.calibration-policy@3b.1",
  calibrationPolicyTrustAnchor: "backyrd.user-intelligence.calibration-policy-trust-anchor@3b.1",
  ...
  calibrationScenario: "backyrd.user-intelligence.calibration-scenario@3b.1",
  calibrationReport: "backyrd.user-intelligence.calibration-report@3b.1",
  calibrationReleaseSummary: "backyrd.user-intelligence.calibration-release-summary@3b.1",
} as const);
