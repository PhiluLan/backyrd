export function createSpotResearchRepository(service) {
  ...
  return Object.freeze({
    ...
    finalizePass: ({ jobId, leaseToken, passKey }, extractions, proposals, metadata) => rpc("backyrd_finalize_spot_research_pass_v2", { p_job_id: jobId, p_lease_token: leaseToken, p_pass_key: passKey, p_extractions: extractions, p_proposals: proposals, p_provider_metadata: metadata }),
