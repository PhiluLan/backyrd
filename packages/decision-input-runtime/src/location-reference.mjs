...
export const DEFAULT_NEAR_DISTANCE_KM=.8;
...
export async function resolveLocationReference({reference,city,maxDistanceKm=DEFAULT_NEAR_DISTANCE_KM,googleApiKey,fetchImpl=globalThis.fetch,timeoutMs=1800}={}){
  ...
  const deterministic=deterministicResolution(referenceText,cityText,maxDistanceKm);
