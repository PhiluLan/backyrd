...
export const FRESHNESS_CLASS_CANDIDATES: Readonly<Record<FoundationArea, string>> = Object.freeze({
  ...
  CURRENT_STATE: "VALID_UNTIL_REQUIRED", PRIMARY_VISIT_PURPOSE: "LONG_LIVED_RECHECK", ONSITE_OFFERINGS: "MEDIUM_TERM_RECHECK",
  VISIT_CONTEXT: "NOT_AUTOMATICALLY_ASSESSABLE", ATMOSPHERE: "NOT_AUTOMATICALLY_ASSESSABLE", DAYPART_CONTEXT: "NOT_AUTOMATICALLY_ASSESSABLE",
});
