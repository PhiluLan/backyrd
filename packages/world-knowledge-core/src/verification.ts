...
export const VERIFIER_ROLES = ["AUTHORIZED_HUMAN_VERIFIER", "INDEPENDENT_SYSTEM_CHECK", "SERVER_CONFIRMED_OWNER", "SERVER_CONFIRMED_ADMIN"] as const;
export const VERIFICATION_AUTHORITY_CLASSES = ["PRODUCT_APPROVED_HUMAN_PROCESS", "PRODUCT_APPROVED_INDEPENDENT_CHECK", "SERVER_BOUND_OWNER_WRITE", "SERVER_BOUND_ADMIN_WRITE"] as const;
