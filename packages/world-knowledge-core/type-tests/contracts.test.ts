...
void reader.readSnapshot({ spotId: "synthetic", contractVersion: "backyrd.world-knowledge.port@1.0", registryVersion: "backyrd.world-knowledge.registry@2.1", registryHash: "a".repeat(64) });
