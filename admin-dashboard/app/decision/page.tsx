...
export default function DecisionPage(){
 ...
 return <div className="bi-page"><header className="bi-header"><div><div className="bi-eyebrow">Historische Legacy-Auswertung</div><h1>Decision Legacy</h1><p>Diese Ansicht enthält ausschließlich frühere Legacy-Sessions und -Signale. Decision-vNext-Daten werden hier nicht beigemischt.</p></div><DateRangeSelector value={preset} onChange={setPreset}/></header>
