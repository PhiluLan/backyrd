...
const categoryLabels: Record<string, string> = {
  ...
  prohibited_symbols:
    "Verbotene oder extremistische Symbole",
};
                  ...
                  >
                    ...
                    >
                      ...
                      row.image_urls.length > 0 ? (
                                ...
                                >
                                  <div
                                    style={{
                                      ...
                                      overflow: "hidden",
                                      background:
                                        "linear-gradient(145deg, rgba(255,255,255,0.035), rgba(0,0,0,0.20))",
                                    }}
                                  >
                                    <img
                                      src={imageUrl}
                                      alt={`Zu prüfendes Bild ${imageIndex + 1}`}
                                      loading="lazy"
                                      style={{
                                        display: "block",
                                        width: "100%",
                        ...
                        >
                          Für diesen Fall ist kein Bild hinterlegt.
                        </div>
                      )}
                    </div>
