...
export default function AdminWorldKnowledgePage() {
  ...
  return <>
    <WorldProductCorrection client={authoringClient} search={searchSpots} rebuild={(spotId, idempotencyKey) => authorizedPost({ action: "product-rebuild", spotId, idempotencyKey })} />
