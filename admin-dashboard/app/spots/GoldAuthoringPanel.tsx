...
export function GoldAuthoringPanel({ spotId, refreshToken = 0 }: { spotId: string; refreshToken?: number }) {
  ...
  return <section className="spot-editor-section hsi-v2">
    ...
    {isGastronomy && <aside className="hsi-semantic-note"><strong>Gastronomie heute ehrlich abbilden</strong><p>Du kannst Bier, Craft Beer, Essen, Apéro und Afterwork als bestätigte Ortsbeschreibung festhalten. Backyrd zeigt diese Wahrheit an; der eingefrorene Matcher nutzt sie noch nicht als eigenes Decision-Signal. Es entsteht keine falsche N4-Zuordnung.</p></aside>}
