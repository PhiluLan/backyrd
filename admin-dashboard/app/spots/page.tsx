...
export default function SpotsPage() {
  ...
  return (
    <div className="bi-page admin-page">
      <AdminPageHeader eyebrow="Spots · gemeinsame Wahrheit" title="Orte verwalten" description="Katalog, World Knowledge und öffentliche Spot-Darstellung greifen hier auf dieselbe Spot-Identität zu." actions={<><DateRangeSelector value={preset} onChange={setPreset}/><Link href="/spots/presentation" className="bi-actionButton">Detail-Darstellung</Link><Link href="/spots/new" className="bi-primaryButton">Neuen Spot anlegen</Link></>} />
