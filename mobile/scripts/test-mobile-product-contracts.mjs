...
const founderLiveControl = read("packages/founder-live-control-plane/src/index.mjs");
...
assert.match(founderLiveDecision, /freshAccessToken/, "Decision requests must carry a fresh authenticated session token to the server boundary");
...
assert.match(founderLiveDecision, /executeDecisionProductInteraction/, "Product interactions must use the sealed single-route boundary");
