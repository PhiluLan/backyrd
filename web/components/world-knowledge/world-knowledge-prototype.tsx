...
function ExpertWorkspace({ state, setState, role, onBack }: { state: PrototypeState; setState: Dispatch<SetStateAction<PrototypeState>>; role: Role; onBack(): void }) {
  ...
  return <div className="wk-expert-shell">
    <aside className="wk-expert-nav">
      ...
      <div className="wk-expert-quality"><span>Technische Katalogabdeckung</span><strong>{quality.technicalCatalogCoverage}%</strong><small>{quality.filledCount} von {quality.relevantCount} Definitionen bearbeitet. Kein Qualitäts- oder Ranking-Signal.</small></div>
    </aside>
